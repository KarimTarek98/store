    ...
    <table class="data">
        ...
        <?php if (false !== $users): foreach ($users as $user): ?>
            <tr>
                ...
                <td>
                    <a href="/privileges/edit/<?= $user->UserId ?>"><i class="fa fa-edit"></i></a>
                    <a href="/privileges/delete/<?= $user->UserId ?>" onclick="if(!confirm('<?= $text_table_control_delete_confirm ?>')) return false;"><i class="fa fa-trash"></i></a>
                </td>
            </tr>
